import { createPublicClient, createWalletClient, http, parseEther, type Address, type Hex, type PublicClient, type WalletClient } from "viem";
...
export async function walletAddress(privateKey?: string): Promise<Address | null> { return privateKey ? privateKeyToAccount(privateKey as Hex).address : null; }
